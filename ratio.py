...
'''def measure_dilation(infrared_path="./images/ir.jpeg", color_path="./images/Color.jpeg"):
    ...
    print("The ratio pupil of Dilation is %d mm.",pupil_mm)
    print("The ratio iris of Dilation is %d mm.",iris_mm)
